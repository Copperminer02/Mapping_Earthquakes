...
let map = L.map('mapid', {
	center: [40.7, -94.5],
	zoom: 3,
	layers: [streets, allEarthquakes, techtonicPlates, majorEarthquake]
});
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json('https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json').then(function(geo) {
    console.log(geo);
    L.geoJSON(geo, {
    style:myStyle,
